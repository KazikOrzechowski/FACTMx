...
class FACTMx_head_GMM_hierarchy_markerLoss(FACTMx_head):
  head_type = 'GMM_hierarchyLoss'
  ...
  def loss(self,
            ...
            beta=1):
    normal_data, counts_data = data
    _batch_size, _subbatch_size, _ = normal_data.shape
  ...
  def from_config(config):
    return FACTMx_head_GMM_hierarchy_markerLoss(**config)
